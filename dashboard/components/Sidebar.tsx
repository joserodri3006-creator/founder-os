          ...
          >
            {VENTURES.filter(v =>
              ...
              <button
                ...
                style={{
                  background: v.id === venture ? 'rgba(200,169,110,0.15)' : 'transparent',
                }}
                onMouseEnter={e => {
                  if (v.id !== venture) e.currentTarget.style.background = 'rgba(255,255,255,0.08)';
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.background = v.id === venture ? 'rgba(200,169,110,0.15)' : 'transparent';
                }}
              >
                <div>
                  <p
