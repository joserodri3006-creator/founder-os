...
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  const allowed = ['first_name', 'last_name', 'company_name', 'email', 'phone', 'city', 'street', 'postal_code', 'country', 'notes', 'venture', 'customer_type', 'status', 'discount_rate', 'payment_terms_days'];
